#include "cEnemyPriest.h"

cEnemyPriest::cEnemyPriest(float initfX):cEnemyUnit()
{
	hp=45;
	shield=0;
	AttackDamege=10;
...
cEnemyPriest::~cEnemyPriest(void)
{
}
	
void cEnemyPriest::Render()
{
	switch(SceneNumber)
	{
...
void cEnemyPriest:: Attack(cUnit people)
{
	if(people.GetX()<m_fX+AttackRange)
		people.Hurt(AttackDamege);
}
void cEnemyPriest::Move()
{
	m_fX-=5;
